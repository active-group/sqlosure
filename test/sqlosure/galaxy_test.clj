...
(defn name-generator
  [n]
  (#'sqlosure.galaxy/make-name-generator n))
...
(deftest make-name-generator-test
  (let [gen (#'sqlosure.galaxy/make-name-generator "foo")]
...
(deftest list->product-test
  (let [underlying (rel/make-project {"foo" (rel/make-attribute-ref "null")}
        ...
        f #'sqlosure.galaxy/list->product]
...
(deftest rename-query-test
  (let [gen (#'sqlosure.galaxy/make-name-generator "dbize")
